...
# train_set = df[(df.Date > '2017-09-15') & (df.Date <= '2017-12-01')].copy()
# test_set = df[(df.Date > '2017-12-01') & (df.Date <= '2018-01-01')].copy()
...
train_set.loc[:,'HomePredictionLR'] = linear_reg.predict(train_set[feature_cols])
test_set.loc[:,'HomePredictionLR'] = linear_reg.predict(test_set[feature_cols])
