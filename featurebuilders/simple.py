...
class ValueLastMatchFeatureBuilder(object):
    ...
    def initialise_state(self, entity_id):
        ...
        self.state_manager.write_state(entity_id, None)
    ...
    def extract_feature_dict(self, event):
        ...
        return {self.feature_name: self.state_manager.read_state(entity_id)}

    def post_extraction_update(self, event):
        self.state_manager.write_state(event[self.entity_field], event[self.field_name])
